...
* The original package name 'com.alataf.business-search' is invalid and this project uses 'com.alataf.business_search' instead.
...
* [Spring Data Elasticsearch](https://docs.spring.io/spring-boot/3.5.10/reference/data/nosql.html#data.nosql.elasticsearch)
...
This project uses [Testcontainers at development time](https://docs.spring.io/spring-boot/3.5.10/reference/features/dev-services.html#features.dev-services.testcontainers).
